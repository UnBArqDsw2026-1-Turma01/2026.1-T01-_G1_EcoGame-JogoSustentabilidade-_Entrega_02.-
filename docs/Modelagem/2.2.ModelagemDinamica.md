...
A primeira versão cobre o fluxo macro de gameplay, estabelecendo os estados principais e suas transições. 

O principal objetivo desse diagrama é estabelecer a dicotomia entre estados de controle da simulação e estados de controle e ajuste do funcionamento do jogo, permitindo visualizar como o jogador é capaz de entrar no jogo, quais estados são principalmente acessíveis dentro do software e como o jogador é capaz de encerrar o software e permanecer o estado de jogo obtido. 

O diagrama é apresentado por meio da Figura 1.
