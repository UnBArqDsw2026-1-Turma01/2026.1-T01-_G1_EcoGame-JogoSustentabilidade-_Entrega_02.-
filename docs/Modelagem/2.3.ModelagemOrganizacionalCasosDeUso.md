...
Nesta versão, o diagrama foi refinado para garantir a consistência com a **modelagem estática**: [Diagrama de Classes](/imagens/diagrama-de-classe-yasmin.jpg) e a **modelagem dinâmica**: [Diagrama de Estados - Jogador](</imagens/Diagrama de Estados - Jogador versão 1.0.jpg>) para formalizar fluxos de exceção através de pontos de extensão detalhados, baseando-se nas diretrizes de extensão da [UML Diagrams](https://www.uml-diagrams.org/use-case-extend.html).
