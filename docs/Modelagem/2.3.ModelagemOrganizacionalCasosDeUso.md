...
Nesta versão, o diagrama foi refinado para garantir a consistência com a modelagem estrutural (Diagrama de Classes) e para formalizar fluxos de exceção através de pontos de extensão detalhados.
